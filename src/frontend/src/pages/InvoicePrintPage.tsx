...
import { amountInWordsINR } from '../utils/amountInWordsINR';
...
export default function InvoicePrintPage() {
  ...
  usePrintOnce({ isReady: isReady && !isLoading });
  ...
  const amountInWords = amountInWordsINR(totals.totalAmount);
  const taxAmountInWords = amountInWordsINR(totals.gstAmount);
  ...
  return (
    <div className="print-page bg-white text-black p-8 max-w-[210mm] mx-auto">
      ...
      <div className="border-2 border-black p-3 mb-4">
        <p className="text-sm">
          <span className="font-semibold">Total Invoice Amount in Words:</span>
        </p>
        <p className="text-sm font-semibold">{amountInWords}</p>
        <p className="text-sm mt-2">
          <span className="font-semibold">Tax Amount in Words:</span>
        </p>
        <p className="text-sm font-semibold">{taxAmountInWords}</p>
      </div>
